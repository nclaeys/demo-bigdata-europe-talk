...
func main() {
	// Read attendees
	attendees, err := readAttendees("../../../transform/data/attendees.csv")
	if err != nil {
		log.Fatalf("Error reading attendees: %v", err)
	}

	// Read sessions
	sessions, err := readSessions("../../../transform/data/sessions.csv")
	if err != nil {
	...
	err = writeAttendanceLogs(logs, "../../../transform/data/attendance.csv")
	if err != nil {
